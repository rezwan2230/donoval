// Gates every request under /platinum/* against the member's engagement level in Clio.
//
// Replaces the HTTP Basic gate that stood here (TIER_PLATINUM_USER / _PASS), which was
...
//
// Levels are independent, not ranked: a platinum session opens /platinum/ and nothing else.
...
export const onRequest = memberGuard("platinum");
