// Gates every request under /reserve/* against the member's engagement level in Clio.
//
// Replaces the HTTP Basic gate that stood here (TIER_RESERVE_USER / _PASS), which was
...
//
// Levels are independent, not ranked: a reserve session opens /reserve/ and nothing else.
...
export const onRequest = memberGuard("reserve");
