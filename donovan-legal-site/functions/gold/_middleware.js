// Gates every request under /gold/* against the member's engagement level in Clio.
//
// Replaces the HTTP Basic gate that stood here (TIER_GOLD_USER / _PASS), which was
...
export const onRequest = memberGuard("gold");
