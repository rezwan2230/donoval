...
/** Appends the widget markup at the end of <body> on every page, and stamps
 *  the suppress class on the protocol pages. One handler doing both, so the
 *  markup and the class can never disagree. */
class FloatAppender {
  ...
  element(el) {
    ...
    el.append(FLOAT_HTML, { html: true });
  }
}
